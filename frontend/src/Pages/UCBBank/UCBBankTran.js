...
import AddTransactionUCB from '../../Components/AddTransactionUCB';
...
function UCBBankTran() {
    ...
    return (
        <div className='w-full h-[calc(100vh-64px)] bg-gray-100 overflow-y-scroll p-5'>
                            ...
                            <div className=' bg-white px-5 py-3 rounded shadow flex justify-between' key={transaction._id}>
                                {
                                    updateModeOpen && currentTransactionId === transaction._id ?
                                        ...
                                        :
                                        <div>
                                            <p className=' mb-2 text-sm'> <span className=' font-medium'>Naration : </span>{transaction.transactionName}</p>
                                            <p className=' mb-2 text-sm'> <span className=' font-medium'>Ref. : </span>{transaction.ref}</p>
                                            <p className=' mb-2 text-sm'> <span className=' font-medium'>Transaction Details : </span>{transaction.transactionDetails}</p>
            ...
            {
                addTransactionMode &&
                <AddTransactionUCB toggleAddTransactionMode={toggleAddTransactionMode} />
            }
