const GenerateRandomTranjections = (startStatementDate, endStatementDate, transactions, transactionQuantity, initialBalance) => {
    ...
    for (let i = 0; i < transactionQuantity; i++) {
        ...
        if (transactions[findRandomParticular].limit > 0) {
            ...
            if (limitTransactionObject[`${transactions[findRandomParticular]._id}`] && !transactions[findRandomParticular].limit > limitTransactionObject[`${transactions[findRandomParticular]._id}`].limit) {

                // increase limit
                limitTransactionObject[`${transactions[findRandomParticular]._id}`] += 1
                ...
                if (transactions[findRandomParticular].transactionType === "credit") {
                    ...
                    if (i === 0) {
                        ...
                        randomTransictionsObject.balance = (parseFloat(randomTransictions[i - 1].balance) + parseFloat(randomDeposit)).toFixed(2);
                    }
                } else {
                    ...
                    if (i === 0) {
                        ...
                        randomTransictionsObject.balance = (parseFloat(randomTransictions[i - 1].balance) - parseFloat(randomWithdrawal)).toFixed(2);
                    }
                }
    ...
    console.log(limitTransactionObject)
